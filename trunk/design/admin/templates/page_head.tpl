...
{/default}
<script language="JavaScript" type="text/javascript" src={"javascript/jquery-latest.js"|ezdesign}></script>
<script language="JavaScript" type="text/javascript" src={"javascript/jquery.ajaxQueue.js"|ezdesign}></script>
<script language="JavaScript" type="text/javascript" src={"javascript/jquery.autocomplete.pack.js"|ezdesign}></script>
<script language="JavaScript" type="text/javascript" src={"javascript/checkout_admin.js"|ezdesign}></script>
