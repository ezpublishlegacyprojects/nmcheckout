...
<tr class="{$Orders.sequence}">
	...
	<td><a href={concat( '/checkout/edit/', $Orders.item.id, '/' )|ezurl}><img src={"images/edit.gif"|ezdesign} title="{'Edit order'|i18n('checkout/edit')}" title="{'Edit order'|i18n('checkout/edit')}" /></a></td>
</tr>
{/section}
</table>
